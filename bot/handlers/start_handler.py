...
# ─────────────────────────────────────────────
# CHANNEL SETUP — shown after successful account connection (Task 6)
# ─────────────────────────────────────────────
CHANNEL_SETUP_MSG = {
    "ar": (
        "📢 <b>خطوة مهمة لبدء النشر!</b>\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "لنشر منتجاتك تلقائياً على قناة تيليجرام خاصة بك:\n\n"
        ...
        "3️⃣ <b>انتظر التأكيد التلقائي</b>\n"
        "   → سيرسل البوت رسالة تأكيد فور اكتشافه\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "💡 أو أرسل: /setchannel -1001234567890\n"
        "🚀 بعد الإعداد ستتمكن من النشر لـ 180+ دولة!"
    ),
    "tr": (
        "📢 <b>Yayın yapmak için önemli adım!</b>\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "Ürünlerinizi Telegram kanalınıza otomatik yayınlamak için:\n\n"
        ...
        "3️⃣ <b>Otomatik onayı bekleyin</b>\n"
    ...
    "en": (
        "📢 <b>Important step to start publishing!</b>\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "To auto-publish products to your Telegram channel:\n\n"
        "1️⃣ <b>Create a Telegram channel</b>\n"
        "   → Tap (+) in Telegram → New Channel\n\n"
        "2️⃣ <b>Add bot as admin</b>\n"
        "   → Open channel → Admins → Add @TopKapTR_bot\n"
        "   → Grant: Post Messages ✅\n\n"
        "3️⃣ <b>Wait for auto-confirmation</b>\n"
        "   → Bot sends confirmation once detected\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
...
async def handle_account_connection(
    ...
    if response is not None:
        ...
        # ── Task 6: Show keyboard FIRST so user sees buttons immediately ──────
        # Then send channel setup instructions as the next step
        await update.message.reply_text(
            get_string(lang, "main_menu_supplier"),
            reply_markup=supplier_main_keyboard(lang),
            parse_mode=ParseMode.HTML,
        )
        # ── Task 6: Channel setup reminder ────────────────────────────────────
        await update.message.reply_text(
            CHANNEL_SETUP_MSG.get(lang, CHANNEL_SETUP_MSG["tr"]),
            parse_mode=ParseMode.HTML,
        )
    else:
        # ── FAILURE ────────────────────────────────────────────────────────────
