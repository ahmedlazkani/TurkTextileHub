...
async def generate_channel_post(
    ...
    system_prompt = (
        ...
        "B. ATTRIBUTES: The 'Attributes' section contains ALL product specs provided by the supplier.\n"
        "   \u2192 ONLY include attributes that are EXPLICITLY present in the provided 'attributes' list.\n"
        ...
        "Attribute label mapping — ONLY translate labels for attributes that ACTUALLY EXIST in the data above:\n"
        "  ⚠️ CRITICAL: Show ONLY attributes present in the provided 'attributes' list.\n"
        "  ⚠️ CRITICAL: If an attribute is NOT in the data → OMIT that line entirely. NEVER write 'Belirtilmemiş' or 'غير محدد' or 'Not specified'.\n"
        "  ⚠️ CRITICAL: If Gender/Cinsiyet/الجنس is NOT in the attributes data → DO NOT write it at all.\n"
        "  القماش / Kumaş / Fabric\n"
        ...
        "  الماركة / Marka / Brand\n"
        "  الجنس / Cinsiyet / Gender  ← ONLY if gender/cinsiyet exists in attributes\n\n"
