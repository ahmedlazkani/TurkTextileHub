...
async def generate_channel_post(
    ...
    system_prompt = (
        ...
        "   💰 [Price label]: [price] ₺\n"
        "   📦 [Min order label]: [qty] adet/pcs/قطعة\n"
        ...
        "   Arabic: المقاسات / القماش / السعر / الحد الأدنى / كود\n"
        "   Turkish: Beden / Kumaş / Fiyat / Min. Sipariş / Kod\n"
        "   English: Size / Fabric / Price / Min. Order / Code\n"
